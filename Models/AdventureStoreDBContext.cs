...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=10.240.201.53\\MSSQLSERVER22DEV;database=AdventureStore2024;User ID=jlescano;Password=GroupJlescanoL001;Connect Timeout=30;Encrypt=True;Trust Server Certificate=True;Application Intent=ReadWrite;Multi Subnet Failover=False;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Address>(entity =>
        {
            entity.HasKey(e => e.AddressId).HasName("PK__Address__CAA247C8C1914616");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Categori__D54EE9B4DA32681F");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__Customer__CD65CB85F8BC8238");

            entity.ToTable("Customer");

            entity.HasIndex(e => e.Email, "UQ__Customer__AB6E6164036C8ECD").IsUnique();

            entity.HasIndex(e => e.Dni, "UQ__Customer__D87608A78DA4C8B1").IsUnique();
        ...
        {
            entity.HasKey(e => e.DeliveryMethodId).HasName("PK__Delivery__E4E8E5D2C8628B99");
        ...
        {
            entity.HasKey(e => e.EmployeeId).HasName("PK__Employee__C52E0BA8609397C2");
        ...
        {
            entity.HasKey(e => e.IngresoSalidaId).HasName("PK__IngresoS__E099542DA51E4897");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Orders__46596229BEE4DA17");
        ...
        {
            entity.HasKey(e => e.OrderDetailId).HasName("PK__OrderDet__3C5A4080E2A26898");
        ...
        {
            entity.HasKey(e => e.PaymentMethodId).HasName("PK__PaymentM__8A3EA9EBAB1FBF01");
        ...
        {
            entity.HasKey(e => e.PersonId).HasName("PK__Person__543848DFA422B636");

            entity.ToTable("Person");

            entity.HasIndex(e => e.Dni, "UQ__Person__D87608A78FAA18B7").IsUnique();
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Products__47027DF529A316A9");
        ...
        {
            entity.HasKey(e => e.PromotionId).HasName("PK__Promotio__2CB9556BA95E7CED");
        ...
        {
            entity.HasKey(e => e.ReviewId).HasName("PK__Reviews__60883D90D6FF7C41");
        ...
        {
            entity.HasKey(e => e.SalesPersonalId).HasName("PK__SalesPer__4FF9999BB3836B55");
        ...
        {
            entity.HasKey(e => e.CartItemId).HasName("PK__Shopping__5D9A6C6E3944B0D1");
        ...
        {
            entity.HasKey(e => e.StockId).HasName("PK__Stock__E8666862ED648215");
        ...
        {
            entity.HasKey(e => e.StoreId).HasName("PK__Stores__A2F2A30CBC56419F");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__UserAcco__B9BE370F7C21E602");

            entity.HasIndex(e => e.Username, "UQ__UserAcco__F3DBC57285F15753").IsUnique();
